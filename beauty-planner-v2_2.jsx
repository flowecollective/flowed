...
@media print{body{padding:30px 40px}@page{margin:0.5in}}
  ...
  html += `<div class="subtitle">Event Beauty Planner</div>`;
  html += `</div>`;
  ...
  html += `<div class="footer">Generated by FLOWE · Event Beauty Planner</div>`;
  html += `</body></html>`;
